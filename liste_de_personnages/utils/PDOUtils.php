...
class PDOUtils
{
     ...
     * @var string
     */
    private const USER = 'projetLolUser';
     ...
     * @param array $parameters_array Tableau de valeurs correspondantes aux paramètres
     *  Exemple
     * [
     *  13,
     *  'Toto'
